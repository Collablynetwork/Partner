...
Would you like to proceed partnership with the project?
  ...
  if (data.startsWith('CONFIRM_YES_')) {
    ...
    try {
      ...
      await bot.telegram.sendMessage(potentialGroupId, `
Thank you for your interest. Please create a group with the team, share the link here, and tag @collablynetworkCEO & @kundanCLB. We'll invite the team for further discussion.
      `);
